...
public abstract class SerialController {
	...
	// ----------------------------------------------------
	public SerialController(String sPort, int iBaudRate) {
		this.sPort = sPort;
	...
	public SerialController(String sPort) {
		this(sPort, 9600);
	}

	public SerialController(String sPort, String sBaudRate) {
...
//					Log.i("SIZE=", size+"");
	...
	// ----------------------------------------------------
	public void setHexLoopData(byte[] sHex) {
		this._bLoopData = sHex;
	}
	...
	public class ComData {
		...
		public ComData(String sPort, byte[] buffer, int size) {
			sComPort = sPort;
			bRec = new byte[size];
